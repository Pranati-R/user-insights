  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 dark:bg-slate-950 px-4 transition-colors duration-200">
      ...
      >
        ...
        {mutation.isError && (
          <p className="text-sm text-rose-600 dark:text-rose-400">Login failed. Check your credentials.</p>
        )}
        <button
          type="submit"
        ...
        <p className="text-center text-sm text-slate-600 dark:text-slate-400">
          Need an account?{' '}
          <Link className="text-rose-600 dark:text-rose-300 hover:underline" to="/signup">
            Sign up
          </Link>
        </p>
      </form>
